 ...
 */
	public function edit($id = null) {
		...
		$pais = $this->Cliente->Paise->find('list');// cambiar pais por paise
		$idiomas = $this->Cliente->Idioma->find('list');
		$hotels = $this->Cliente->Hotele->find('list');//cambiar hotel por hotele
		$agencias = $this->Cliente->Agencia->find('list');//cambiar agencium por agencia
		$circustanciasMedicas = $this->Cliente->CircustanciasMedica->find('list');
		$this->set(compact('pais', 'idiomas', 'hotels', 'agencias', 'circustanciasMedicas'));
	}
